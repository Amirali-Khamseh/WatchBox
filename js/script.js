  ...
  results.forEach((result) => {
    ...
    div.innerHTML = `
        ...
        ? `<img
              ...
              class="card-img-top"
              alt="${state.searchObj.type === 'movie' ? result.title : result.name
        }"
            />`
        : `<img
            src="../images/no-image.png"
          ...
          <div class="card-body">
            <h5 class="card-title">${state.searchObj.type === 'movie' ? result.title : result.name
      }</h5>
            <p class="card-text">
            <small class="text-muted">⭐${result.vote_average.toFixed(1)}/10</small>              
            </p>
          </div>
        `;
