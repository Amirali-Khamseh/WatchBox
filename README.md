...
**_Live demo :_** https://watchbox-amirkhamseh.netlify.app/

### Modern JavaScript-Based Application for Previewing Latest Movies and Shows

Discover the latest movies and TV shows with WatchBox - an innovative JavaScript-based app that provides previews and detailed insights using the TMDB API.
